...
<iframe width="560" height="315" src="https://www.youtube.com/embed/gMGW81naaTU?si=OFI0L66-lcMWYQc_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<img width="400" height="300" alt="IMG_0969" src="https://github.com/user-attachments/assets/755007f5-59ee-4207-8331-efc4a2422405" /> Pen Sideways 

<img width="300" height="400" alt="Pen Up Test" src="https://github.com/user-attachments/assets/2f13fb85-4b14-4d77-bf77-77b79764fbe0" /> Pen Upwards 

<img width="300" height="400" alt="Sticky Note Test" src="https://github.com/user-attachments/assets/7dc2e828-4c8e-4b36-8eda-b75ff617ea40" /> Sticky Note 
...
- I used FreeCAD for this project, very underated
- My original intention was for the honeycomb structure to deform toward the object being gripped. However, after printing and testing the design, I found that the structure primarily flexed up and down instead of in the direction I intended. To address this issue, I modified the design by cutting the columns between the honeycomb sections, which increased flexibility along the desired axis.
- This experience taught me that when designing flexible structures, the direction of flexibility can be just as important as the amount of flexibility, and that testing and iteration are essential parts of the engineering design process.
